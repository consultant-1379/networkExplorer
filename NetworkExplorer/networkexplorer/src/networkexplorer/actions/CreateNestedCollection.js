define([
     ...
     * ===
     * id: networkexplorer-create-nested-collection
     *
     * This action launches a flyout panel allowing user to create a nested collection.
     *
    ...
    return ActionLibrary.Action.extend({
        ...
        run: function(callbackObject, data) {
            ...
            lifecycle.onReady({
                message: strings.get('networkexplorer-create-nested-collection.launchingAction')
            });
            ...
            new Promise(function(resolve, reject) {
                ...
                if(data[0].isCustomTopology) {
                    headerText = 'customTopologyLabel';
                    parentObject = {};
                }
                ...
                collectionCreator = new CollectionCreator({
                    ...
                    parent: parentObject,
                    isCustomTopology: data[0].isCustomTopology
                });

                // Display the flyout with CollectionCreator
                Container.getEventBus().publish('flyout:show', {
                    header: strings.get('networkexplorer-create-nested-collection.' + headerText),
